    ...
    <div className="mb-8 rounded-lg bg-white p-0 pb-12 shadow-lg lg:p-8">
      <div className="relative mb-6 overflow-hidden pb-80 shadow-md">
        <img
          ...
          alt={post.title}
          className="absolute h-full max-h-80 w-full rounded-t-lg object-cover shadow-lg lg:rounded-lg"
        />
      </div>
      <h1 className="mb-8 cursor-pointer text-center text-3xl font-semibold transition duration-500 hover:text-red-600">
      ...
      <div className="mb-8 block w-full items-center justify-center text-center lg:flex">
        <div className="mb-4 mr-8 flex w-full items-center justify-center lg:mb-0 lg:w-auto">
          ...
          />
          <p className="alignt-middle ml-2 inline text-lg text-gray-700">
            {post.author.name}
          </p>
        </div>
